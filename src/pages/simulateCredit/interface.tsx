      ...
      >
        <Stack gap="24px" direction="column" height="100%" width="100%">
          ...
          <Stack direction="column">
            ...
            {currentStepsNumber &&
              currentStepsNumber.id === stepsSimulateCredit.destination.id && (
                <MoneyDestination
            ...
            {currentStepsNumber &&
              currentStepsNumber.id ===
                stepsSimulateCredit.productSelection.id && (
                <ProductSelection
                  initialValues={{
                    selectedProducts,
            ...
            {currentStepsNumber &&
              currentStepsNumber.id ===
                stepsSimulateCredit.extraBorrowers.id && (
                <ExtraDebtors
            ...
            {currentStepsNumber &&
              currentStepsNumber.id === stepsSimulateCredit.loanAmount.id && (
                <LoanAmount
