...
import { Crsimulations } from "../prospect/components/CreditProspect";
import { StyledMarginPrint, StyledPrint } from "./styles";
import { datasimulations, titlesModal } from "./config";
