...
import { disbursemenTabs } from "./steps/disbursementGeneral/config";
...
import { applyForCreditConfig } from "./config/submitCreditApplication.config";
        ...
        >
          ...
          >
            <Stack gap="24px" direction="column" height="100%" width="100%">
              ...
              />
              <Breadcrumbs crumbs={applyForCreditConfig.crumbs} />
